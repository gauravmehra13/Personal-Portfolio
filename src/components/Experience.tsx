...
const Experience = () => {
  ...
  const experiences = [
    {
      ...
      period: '2023 - Present',
      description: 'Working as a Software Engineer focusing on frontend development and application architecture.',
      achievements: [
    ...
    /*{
      ...
      period: '2019 - 2021',
      description: 'Developed full-stack web applications with React, Node.js, and MongoDB, working in an agile environment with cross-functional teams.',
      achievements: [
        'Built the company\'s flagship product from ground up',
    ...
    },
    {
      ...
      period: '2017 - 2019',
      description: 'Designed and developed responsive web interfaces for various clients using HTML, CSS, JavaScript, and jQuery.',
      achievements: [
        'Completed over 20 client projects with 100% satisfaction rate',
        'Reduced load time of main client site by 45%',
  ...
  const activeExperiences = experiences.filter(exp => !exp.company.includes('/*'));
  ...
  return (
    <section id="experience" className="py-16 md:py-24 px-4 md:px-0">
      <div className="container mx-auto max-w-6xl">
        ...
        <div ref={ref} className={`space-y-12 relative ${isSingleExperience ? 'max-w-4xl mx-auto' : ''}`}>
          ...
          {experiences.map((exp, index) => (
            ...
            >
              ...
              <div className={`${
                isSingleExperience 
                  ? 'w-full md:w-3/4' 
                  : `md:w-1/2 ${index % 2 === 0 ? 'md:pr-16 md:text-right md:self-end' : 'md:pl-16 md:ml-auto'}`
              }`}>
                <div className={`bg-white dark:bg-gray-800 p-6 md:p-8 rounded-xl shadow-soft border-l-4 ${exp.color}`}>
                    ...
                    <ul className="space-y-2">
                      {exp.achievements.map((achievement, i) => (
                        <li key={i} className="flex items-start">
                          <CheckCircle2 className="flex-shrink-0 text-green-500 dark:text-green-400 mr-2 mt-1" size={16} />
