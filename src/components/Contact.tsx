...
const Contact = () => {
  ...
  return (
    <section id="contact" className="py-16 md:py-24 px-4 md:px-0 bg-gray-50 dark:bg-zinc-900">
      <div className="container mx-auto max-w-6xl">
        ...
        >
          ...
          <motion.div
            ...
            className="bg-white dark:bg-zinc-800 rounded-xl shadow-soft-lg p-6 md:p-8"
          >
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div>
                    ...
                    <input
                      ...
                      required
                      className="w-full px-4 py-3 rounded-lg border border-gray-300 dark:border-gray-700 bg-white dark:bg-zinc-800 text-gray-800 dark:text-gray-200 focus:ring-2 focus:ring-primary-500 dark:focus:ring-primary-400 focus:border-transparent transition-colors"
                    />
                  </div>
                  <div>
            ...
            <div className="space-y-6">
              {contactInfo.map((info, index) => (
                <motion.a
                  ...
                  className="flex p-4 bg-white dark:bg-zinc-800 rounded-xl shadow-soft hover:shadow-soft-lg transition-shadow group"
            ...
            <div className="mt-12">
              ...
              <div className="flex space-x-4">
                <motion.a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="p-3 bg-gray-100 dark:bg-zinc-700 hover:bg-gray-200 dark:hover:bg-zinc-600 rounded-full text-gray-700 dark:text-gray-300 transition-colors"
                  whileHover={{ y: -5 }}
